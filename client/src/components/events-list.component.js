...
const Event = props => (
  <tr>
    ...
    <td className={props.event.completed ? 'completed' : ''}><Link to="https://www.google.com/maps/search/?api=1&query="{props.event.job_address}>{props.event.job_address}</Link></td>
