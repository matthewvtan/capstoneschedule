...
const Event = props => (
  <TableRow>
    <TableCell align="center" className={props.event.completed ? 'completed' : ''}>{moment(props.event.start).format("MM/DD/YYYY hh:mm a")}</TableCell>
    <TableCell align="center">
        <Link to={"/complete/"+props.event._id}>Complete</Link>
    </TableCell>
    <TableCell align="center" className={props.event.completed ? 'completed' : ''}>{props.event.title}</TableCell>
    ...
    <TableCell align="center" className={props.event.completed ? 'completed' : ''}>{props.event.completed ? 'Complete' : 'Incomplete'}</TableCell>
    <TableCell align="center">
          ...
          <div>
            <Paper>
                ...
                <Table className="table-responsive table-bordered" style={{ marginTop: 20}}>
                  <TableHead>
                    <TableRow>
                      <TableCell align="center">Date / Start Time</TableCell>
